...
def main():
    ...
    for family, chars in mapping.items():
        for char, char_data in chars.items():
            ...
            if family == "Script-Regular":
                tfm_char = font_name_to_tfm[font].get_char_metrics(tex_char_num, fix_rsfs=True)
            else:
            ...
            skewkern = 0.0
            if font_skewchar[font] and font_skewchar[font] in tfm_char.kern_table:
    ...
    sys.stdout.write(json.dumps(families, separators=(",", ":"), sort_keys=True))
