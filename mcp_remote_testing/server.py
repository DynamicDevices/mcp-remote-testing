...
from mcp_remote_testing.tools.batch_operations import (
    batch_operation,
    get_device_groups,
    regression_test,
)
from mcp_remote_testing.tools.device_manager import list_devices, ssh_to_device, test_device
...
from mcp_remote_testing.tools.power_analysis import (
    analyze_power_logs,
    compare_power_profiles,
    monitor_low_power,
)
from mcp_remote_testing.tools.power_monitor import get_power_logs, start_power_monitoring
from mcp_remote_testing.tools.tasmota_control import list_tasmota_devices, tasmota_control
...
async def handle_call_tool(name: str, arguments: Dict[str, Any]) -> List[TextContent]:
    ...
    try:
        ...
        return [TextContent(type="text", text=json.dumps({"error": f"Tool execution failed: {e!s}"}, indent=2))]
